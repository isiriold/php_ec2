...
public function productdetailMGR( $product_detail_id=null ,$product_id=null ,$detail_group_concept_id=null ,$detail_type_concept_id=null ,$detail_name=null ,$detail_description=null ,$detail_value=null ,$active_flag=null ,$sort=null  ) {
...
$theSQL = <<<q
call `DPM_UP_PRODUCT_DETAIL_MGR`( $arg[0],$arg[1],$arg[2],$arg[3],$arg[4],$arg[5],$arg[6],$arg[7],$arg[8] );
q;
//echo $theSQL;
return $this->runQuery( $theSQL );
}
...
public function proddetailGetAdmin($product_id  = null,$company_id  = null, $product_name  = null,  
...
$detail_name  = null, $detail_description  = null, $detail_value = null, $product_detail_active_flag = null)
{
 $arg = func_get_args();
 $this->paramSafe( $arg, $arg );
$theSQL = <<<q
call `DPM_UP_V_PRODUCT_GET_ADMIN`
...
public function proddetailGet($member_id = null,$product_id  = null,$company_id  = null, $product_name  = null,  
$product_desc = null,  $product_code  = null, $product_active_flag  = null, $product_detail_id  = null, 
$detail_group_concept_id  = null, $detail_group_concept_code  = null, $detail_group_active_flag  = null, 
$detail_type_concept_id  = null, $detail_type_concept_code  = null, $detail_type_active_flag  = null, 
$detail_name  = null, $detail_description  = null, $detail_value = null, $product_detail_active_flag = null)
...
($arg[0], $arg[1], $arg[2], $arg[3], $arg[4], $arg[5], $arg[6], $arg[7], $arg[8], $arg[9], $arg[10], $arg[11], $arg[12], $arg[13], $arg[14], $arg[15], $arg[16], $arg[17])
q;
...
$prefixid = "", $firstname = "", $middlename = "", $lastname = "", $specialty="",$active_flag = "", 
$prefixTN = "0", $fistTN = "0", $middleTN = "0", $lastTN = "0" , $specialTN = "0") {
	$arg = func_get_args();
	$this->paramSafe( $arg, $arg );
$theSQL = <<<zzz
...
public function memberAdminMGR( $memberid = "", $login = "", $pword = "", $email = "", 
$prefixid = "", $firstname = "", $middlename = "", $lastname = "", $specialty="",$active_flag = "", 
$prefixTN = "0", $fistTN = "0", $middleTN = "0", $lastTN = "0" , $specialTN = "0", $Laffinity ="unknown", $Ltherapies ="unknown", $Lpalatech ="unknown") {
	$arg = func_get_args();
	$this->paramSafe( $arg, $arg );
$theSQL = <<<zzz
call `DPM_UP_MEMBER_MGR_ADMIN`
($arg[0], $arg[1], $arg[2], $arg[3], $arg[4], $arg[5], $arg[6], $arg[7], $arg[8], $arg[9], $arg[10], $arg[11], $arg[12],$arg[13],$arg[14],$arg[15],$arg[16],$arg[17] )
zzz;
//return $theSQL ;
return $this->runQuery( $theSQL );
...
public function signUp(
	...
	$this->paramSafe( $arg , $arg );
$theSQL = <<<zz
call DPM_UP_MEMBER_SGNUP($arg[0], $arg[1], $arg[2], $arg[3], $arg[4], $arg[5])
zz;
   return $this->runQuery( $theSQL );
}
...
public function makeOrder(
	...
	$this->paramSafe( $arg , $arg );
$theSQL = <<<zz
call DPM_UP_ORDER($arg[0], $arg[1], $arg[2])
zz;
   return $this->runQuery( $theSQL );
}
...
public function askQuestion(
	...
	$this->paramSafe( $arg , $arg );
$theSQL = <<<zz
call DPM_UP_QUESTION($arg[0], $arg[1], $arg[2])
zz;
   return $this->runQuery( $theSQL );
}

public function pullShipments($memberid = null){
	$arg = func_get_args();
	$this->paramSafe( $arg , $arg );
	
	$theSQL = <<<zz
call DPM_UP_ORDER_SHIP_GET($arg[0])
zz;
	
	return $this->runQuery( $theSQL );
}

public function pullResponses($memberid = null){
	$arg = func_get_args();
	$this->paramSafe( $arg , $arg );
	
	$theSQL = <<<zz
call DPM_UP_QUEST_RESPONSES_GET($arg[0])
zz;
...
$theSQL = <<<zz
SELECT * FROM DPM_V_TRACKING ORDER BY TRACKING_TIME desc
zz;
   return $this->runQuery( $theSQL );
}//trackerreport
