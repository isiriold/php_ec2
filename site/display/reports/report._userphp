 <?php
   ...
   $Request = "select login, month_name,sum(time_spent_mins)/nbr_of_sessions as avg_time_spent_per_sess
					from dpm_maindb_new.dpm_t_rpt_usr_activity
					group by login,month_name"  ;
   ...
   {  
     echo "<br/>";
     echo "{$row["avg_time_spent_per_sess"]}";
   ...
   $Test->drawTitle(60,22,"report 1",50,50,50,585);     
   $Test->Render("report1.png");
   //$Test->Render->Stroke()   
