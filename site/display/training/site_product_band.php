...
<div id="${B}_$BG" class="fl1 "  style="display:block;">
zz;
...
$BG++;
$someHTML.= <<<zzz
</div><div id="${B}_${BG}" class="fl1 "  style="display:none;">
...
$tglLnks .= makeButton( $type="BUTTON", $display="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", $id="${tmpId}_LINK", $func="toggleBand( '${B}', '$tmpId');", $class="$tlClass" );
