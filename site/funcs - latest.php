...
$rtn .= <<<zzz
<div class="insetbox1" ID="$theDiv">
<a href="javascript:void(0);"
   onclick="loadVideo('$theDiv', '$Lbvalue')"
   style="height:100%;width:100%"
   ><embed src="$Lbvalue&autoplay=0&rel=0" type="application/x-shockwave-flash" wmode="transparent" ></embed></a>
</div>
zzz;
break;
}
