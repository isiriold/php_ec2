...
$productDescription = makeInput("textarea","detaildescription_$idx","txt3 txtDescrp","");
...
<div class="ht2">
	<div class="fl1 wid5"><label  for="detailtitle_$idx">Title</label></div>
...
<div class="ht2">
	<div class="fl1 wid5"><label for="detaildescription_$idx">Description</label></div>
...
<br/>
<div class="ht2">
	 <div class="fl1 wid5"><label for="detailband_$idx">Band</label></div>
	 <div class="">$mBand</div>
	 <div class="clear"></div>
</div>
...
<div class="ht2">
	 <div class="fl1 wid5"><label for="detailtype_$idx">Type</label></div>
	 <div class="">$mType</div>
	 <div class="clear"></div>
</div> 
<div class="ht2">
	 <div class="fl1 wid5"><label for="active_$idx">Active</label></div>
	 <div class="">$mActive</div>
	 <div class="clear"></div>
	 <div class="fl1 wid5"><label for="sort_$idx">Sort</label></div>
	 <div class="">$mSort</div>
